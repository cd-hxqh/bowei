 ...
 */
public class PlanMaterialDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan_material_info);
    ...
    protected void initView() {
        titlename.setText(getResources().getString(R.string.plan_material));
